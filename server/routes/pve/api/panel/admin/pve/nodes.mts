...
const columns = [{ dataIndex: 'id', title: 'ID', dataType: 'int' }, { dataIndex: 'region_id', title: '地区', component: 'select', rules: [{ required: true, message: '请选择地区' }] }, { dataIndex: 'name', title: '节点', component: 'textbox' }, { dataIndex: 'host', title: 'Host', component: 'textbox' }, { dataIndex: 'port', title: '端口', component: 'textbox', dataType: 'int' }, { dataIndex: 'api_user', title: 'API 用户', component: 'textbox' }, { dataIndex: 'api_token_id', title: 'Token ID', component: 'textbox' }, { dataIndex: 'api_token_secret', title: 'Token Secret', component: 'textbox', inputType: 'password' }, { dataIndex: 'status', title: '状态', component: 'switch' }];
