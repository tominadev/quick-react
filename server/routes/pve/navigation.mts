...
const navigation: MenuNode[] = [{
	label: '管理后台', key: 'panel/admin', icon: 'appstore', dashboardPath: '/panel/admin/pve/dashboard', roles: ['admin'],
	children: [{
		label: 'PVE', key: 'pve', icon: 'appstore', navigationGroup: 'pve', dropdown: false, title: 'PVE 管理', description: '管理 PVE 地区、节点、实例规格和虚拟机', roles: ['admin'],
		children: [
