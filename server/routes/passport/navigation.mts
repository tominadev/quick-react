...
const navigation: MenuNode[] = [{
	...
	label: '管理后台', key: 'panel/admin', icon: 'appstore', dashboardPath: '/panel/admin/passport/dashboard', children: [{
			label: 'Passport', key: 'passport', icon: 'appstore', navigationGroup: 'passport', dropdown: false, title: 'Passport 管理', description: '管理 Accounts 身份服务', roles: ['platform_admin'], children: [{
