...
import { filterNavigationByRoles, mergeNavigation, normalizePagePath, resolveDashboardPaths, uniquePageDefinitions } from '@shared/navigation-tree.mjs';
...
export const getFullSiteNavigation = (siteChain: string[]) => {
	...
	return resolveDashboardPaths(navigation);
};
...
export const getPageMetadata = (pathname: string, menuItems: MenuNode[], pageSuffix = '.html') => {
	pathname = normalizePagePath(pathname, pageSuffix);
