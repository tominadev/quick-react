...
export type SiteSettings = { contactEmail: string; footer: string; logoutLocalEnabled: boolean; logoutPassportEnabled: boolean; logoutAllEnabled: boolean; apiBootstrapEnabled: boolean };
export const defaultSiteSettings: SiteSettings = { contactEmail: '', footer: `Ant Design ©${new Date().getFullYear()} Created by Ant UED`, logoutLocalEnabled: true, logoutPassportEnabled: true, logoutAllEnabled: true, apiBootstrapEnabled: false };
export const normalizeSiteSettings = (value: unknown): SiteSettings => {
	...
	return {
		...
		apiBootstrapEnabled: typeof source.apiBootstrapEnabled === 'boolean' ? source.apiBootstrapEnabled : false,
	};
};
