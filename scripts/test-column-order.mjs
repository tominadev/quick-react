 ...
 */
const routeTables = {
	'base/api/panel/admin/base/audit/approvals.mts': 'base_audit_approvals',
	'base/api/panel/admin/base/audit/records.mts': 'base_audits',
	...
	'sms/api/panel/admin/sms/platform-keys.mts': 'sms_platform_keys',
	'sms/api/panel/admin/sms/messages.mts': 'sms_messages',
	'sms/api/panel/admin/sms/tokens.mts': 'sms_shortcut_tokens',
	'sms/api/panel/user/sms/client-keys.mts': 'sms_integration_client_keys',
	'sms/api/panel/user/sms/integration-clients.mts': 'sms_integration_clients',
	'sms/api/panel/user/sms/messages.mts': 'sms_messages',
	'sms/api/panel/user/sms/push-endpoints.mts': 'sms_push_endpoints',
