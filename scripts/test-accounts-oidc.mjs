...
try {
	...
	const now = Date.now(), userId = 1000000000000000000n, fingerprint = 'a'.repeat(64), fingerprintData = JSON.stringify({ canvas_crc32: 'aaaaaaaa' }), sessionId = crypto.randomUUID(), sessionToken = crypto.randomUUID();
