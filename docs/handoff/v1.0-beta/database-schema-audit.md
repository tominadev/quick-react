...
- Base：`base_tenants`、`base_branches`、`base_hosts`、`base_users`、`base_sessions`、`base_configs`、`base_bootstraps`、`base_oidc_login_requests`、`base_oidc_users`、`base_oidc_sessions`、`base_devices`、`base_device_users`、`base_device_snapshots`、`base_audit_transitions`、`base_audits`、`base_user_credentials`、`base_user_profiles`。
