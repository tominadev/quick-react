...
-- DropIndex
DROP INDEX `passport_users_user_id_deleted_at_key` ON `passport_users`;

-- DropIndex
DROP INDEX `passport_user_email_otps_user_id_status_created_at_idx` ON `passport_user_email_otps`;

-- DropIndex
DROP INDEX `passport_user_credentials_user_id_created_at_id_idx` ON `passport_user_credentials`;

-- DropIndex
DROP INDEX `passport_sessions_user_id_idx` ON `passport_sessions`;

-- DropIndex
DROP INDEX `passport_device_users_device_id_user_id_deleted_at_key` ON `passport_device_users`;

-- DropIndex
DROP INDEX `passport_user_emails_user_id_email_id_deleted_at_key` ON `passport_user_emails`;

-- DropIndex
DROP INDEX `passport_site_sessions_user_id_idx` ON `passport_site_sessions`;

-- DropIndex
DROP INDEX `passport_external_identities_user_id_idx` ON `passport_external_identities`;

-- DropIndex
DROP INDEX `passport_user_profiles_user_id_deleted_at_key` ON `passport_user_profiles`;
...
-- AlterTable
ALTER TABLE `passport_devices` MODIFY `key` VARCHAR(36) NOT NULL;
...
ALTER TABLE `passport_external_login_states` DROP COLUMN `qr_user_id`,
    ADD COLUMN `key` VARCHAR(36) NOT NULL,
    ADD COLUMN `qr_user_key` VARCHAR(36) NULL;
