...
-- DropIndex
DROP INDEX `base_branches_owner_tid_key_key` ON `base_branches`;

-- DropIndex
DROP INDEX `base_configs_owner_tid_key_key` ON `base_configs`;

-- DropIndex
DROP INDEX `base_bootstrap_owner_tid_key_key` ON `base_bootstrap`;
