...
-- DropIndex
DROP INDEX "global_cloud_object_storage_buckets_cloud_credential_id_endpoint_bucket_deleted_at_key";

-- DropIndex
DROP INDEX "global_cloud_object_storage_bindings_id_site_key_deleted_at_key";

-- DropIndex
DROP INDEX "global_cloud_object_storage_bindings_site_key_bucket_id_key_prefix_deleted_at_key";

-- DropIndex
DROP INDEX "global_cloud_object_storage_binding_purposes_binding_id_purpose_deleted_at_key";
...
-- DropIndex
DROP INDEX "global_cloud_email_channels_cloud_credential_id_region_account_name_deleted_at_key";

-- DropIndex
DROP INDEX "global_cloud_email_bindings_site_key_channel_id_template_id_purpose_deleted_at_key";

-- DropIndex
DROP INDEX "global_cloud_email_template_publications_template_id_cloud_credential_id_region_deleted_at_key";
